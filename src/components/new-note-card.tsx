...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps){
    ...
    function handleStartRecording(){        
        ...
        const isSpeechRecognitionAPIAvailabel = 'SpeechRecognition' in window || 'webkitSpeechRecognition' in window
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className="text-left rounded-md bg-slate-700 flex flex-col p-5 gap-3 space-y-3 overflow-hidden relative outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
